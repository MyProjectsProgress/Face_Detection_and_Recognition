...
Mat readFaces(int noOfFaces, vector<string>& loadedFaceID)
{
    ...
    string facesDataPath = "C:/Users/ahmad/source/repos/opencv test/data/facesdata.txt";
...
Mat readMean()
{
    ...
    string meanPath = "C:/Users/ahmad/source/repos/opencv test/data/mean.txt";
...
Mat readEigen(int noOfFaces)
{
    ...
    string eigenPath = "C:/Users/ahmad/source/repos/opencv test/data/eigen.txt";
